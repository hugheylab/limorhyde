...
```{r, message = FALSE}
# TODO: make sure the Suggests section of the DESCRIPTION file is up-to-date
library(annotate)
library(limorhyde)
library(GEOquery)
library(dplyr)
...
source('get_gene_symbols.R') # TODO: this is fragile, see http://r-pkgs.had.co.nz/data.html#data-extdata for a better way
```
...
```{r, message = FALSE}
# TODO: I'd prefer to put the code to make rhyRain into a function and move the function to the script currently called get_gene_symbols.R (the script should probably be renamed to something like vignette_functions.R)
# rhyRain = rainWrapper(sm, emat, 'cond')
